...
class ApoptosisPlugin(CambrianPlugin):
    """Plugin wrapper for the apoptosis module."""

    name = "apoptosis"
    description = "Apoptosis control: programmed removal of low-fitness agents to prevent population stagnation."
    category = "selection"
    impact = None
