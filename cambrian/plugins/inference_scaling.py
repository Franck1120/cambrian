...
class InferenceScalingPlugin(CambrianPlugin):
    """Plugin wrapper for the inference_scaling module."""

    name = "inference_scaling"
    description = "Inference-time scaling: Best-of-N sampling and beam search to extract higher quality agent outputs."
    category = "evaluation"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # BestOfN/BeamSearch are used standalone; no engine hooks required
