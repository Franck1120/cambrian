...
class CompressPlugin(CambrianPlugin):
    """Plugin wrapper for the compress module."""

    name = "compress"
    description = "Prompt compression: prunes and distills agent system prompts to prevent context bloat across generations."
    category = "optimization"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # caveman_compress/procut_prune are used standalone; no engine hooks required
