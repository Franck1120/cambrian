...
class MetamorphosisPlugin(CambrianPlugin):
    """Plugin wrapper for the metamorphosis module."""

    name = "metamorphosis"
    description = "Metamorphosis: agents transform through distinct developmental phases for task specialization."
    category = "adaptation"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # MetamorphosisController is used standalone; no engine hooks required
