...
class GlossaloliaPlugin(CambrianPlugin):
    """Plugin wrapper for the glossolalia module."""

    name = "glossolalia"
    description = "Glossolalia reasoning: explores novel solution spaces via unconstrained language-guided mutations."
    category = "language"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # GlossaloliaReasoner is used standalone; no engine hooks required
