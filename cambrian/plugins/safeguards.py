...
class SafeguardsPlugin(CambrianPlugin):
    """Plugin wrapper for the safeguards module."""

    name = "safeguards"
    description = "Goal drift detection and fitness anomaly monitoring for safe, stable evolutionary runs."
    category = "safeguard"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # SafeguardController is used standalone; no engine hooks required
