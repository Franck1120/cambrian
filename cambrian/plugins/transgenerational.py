...
class TransgenerationalPlugin(CambrianPlugin):
    """Plugin wrapper for the transgenerational module."""

    name = "transgenerational"
    description = "Transgenerational epigenetics: propagates learned traits across generations without direct mutation."
    category = "memory"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # TransgenerationalRegistry is used standalone; no engine hooks required
