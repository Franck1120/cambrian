...
class MoaPlugin(CambrianPlugin):
    """Plugin wrapper for the moa module."""

    name = "moa"
    description = "Mixture-of-Agents and Quantum Tunneling: escapes local optima via multi-agent voting and tunneling mutations."
    category = "optimization"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # MixtureOfAgents and QuantumTunneler are used standalone; no engine hooks required
