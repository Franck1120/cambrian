...
class EnsemblePlugin(CambrianPlugin):
    """Plugin wrapper for the ensemble module."""

    name = "ensemble"
    description = "Ensemble evaluation: aggregates responses from multiple agents for more reliable fitness scoring."
    category = "evaluation"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # AgentEnsemble/BoostingEnsemble are used standalone; no engine hooks required
