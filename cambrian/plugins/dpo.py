...
class DpoPlugin(CambrianPlugin):
    """Plugin wrapper for the dpo module."""

    name = "dpo"
    description = "Direct Preference Optimization: selects and ranks agents based on preference pairs for fine-grained control."
    category = "evaluation"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # DPOSelector/DPOTrainer are used standalone; no engine hooks required
