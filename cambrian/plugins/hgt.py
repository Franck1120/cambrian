...
class HgtPlugin(CambrianPlugin):
    """Plugin wrapper for the hgt module."""

    name = "hgt"
    description = "Horizontal Gene Transfer: borrows genome fragments from external pools to increase diversity."
    category = "memory"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # HGTransfer is used standalone; no engine hooks required
