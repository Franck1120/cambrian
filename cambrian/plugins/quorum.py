...
class QuorumPlugin(CambrianPlugin):
    """Plugin wrapper for the quorum module."""

    name = "quorum"
    description = "Quorum sensing: dynamically adjusts mutation rates based on population-level consensus signals."
    category = "selection"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # QuorumSensor is used standalone; no engine hooks required
