...
class FractalPlugin(CambrianPlugin):
    """Plugin wrapper for the fractal module."""

    name = "fractal"
    description = "Fractal evolution: applies self-similar evolutionary strategies at multiple scales for richer diversity."
    category = "optimization"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # FractalEvolution is used standalone; no engine hooks required
