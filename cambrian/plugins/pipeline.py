...
class PipelinePlugin(CambrianPlugin):
    """Plugin wrapper for the pipeline module."""

    name = "pipeline"
    description = "Pipeline evolution: evolves multi-step agent pipelines for complex, decomposable tasks."
    category = "synthesis"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # PipelineEvolutionEngine is used standalone; no engine hooks required
