...
class DreamPlugin(CambrianPlugin):
    """Plugin wrapper for the dream module."""

    name = "dream"
    description = "Offline dream-phase replay: synthesizes hypothetical scenarios to prevent overfitting."
    category = "memory"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # DreamPhase is used standalone; no engine hooks required
