...
class RedTeamPlugin(CambrianPlugin):
    """Plugin wrapper for the red_team module."""

    name = "red_team"
    description = "Red team evaluation: adversarial agents systematically probe the robustness of the evolving population."
    category = "evaluation"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # RedTeamSession is used standalone; no engine hooks required
