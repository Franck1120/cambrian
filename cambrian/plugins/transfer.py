...
class TransferPlugin(CambrianPlugin):
    """Plugin wrapper for the transfer module."""

    name = "transfer"
    description = "Transfer learning: adapts genomes from related tasks to accelerate convergence on new problems."
    category = "optimization"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # TransferAdapter is used standalone; no engine hooks required
