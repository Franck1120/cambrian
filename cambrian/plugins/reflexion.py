...
class ReflexionPlugin(CambrianPlugin):
    """Plugin wrapper for the reflexion module."""

    name = "reflexion"
    description = "Reflexion-style self-evaluation: agents critique and iteratively improve their own outputs."
    category = "evaluation"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # ReflexionEvaluator is used standalone; no engine hooks required
