...
class CodeGenomePlugin(CambrianPlugin):
    """Plugin wrapper for the code_genome module."""

    name = "code_genome"
    description = "Code genome evolution: synthesizes and evolves executable Python code via LLM-guided mutation."
    category = "synthesis"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # CodeEvolutionEngine is used standalone; no engine hooks required
