...
class EcosystemPlugin(CambrianPlugin):
    """Plugin wrapper for the ecosystem module."""

    name = "ecosystem"
    description = "Ecosystem simulation: models ecological interactions (predator-prey, symbiosis) between agent populations."
    category = "simulation"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # EcosystemInteraction is used standalone; no engine hooks required
