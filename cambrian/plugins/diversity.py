...
class DiversityPlugin(CambrianPlugin):
    """Plugin wrapper for the diversity module."""

    name = "diversity"
    description = "MAP-Elites diversity archive: maintains quality-diversity coverage to prevent premature convergence."
    category = "selection"
    impact = None

    def register(self, engine: Any) -> None:
        pass  # MAPElites is used standalone; no engine hooks required
